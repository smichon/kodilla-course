...
public class ForumUserTestSuite {
    ...
    public void testGetLocationOfFriends() {
        ...
        user1.addFriends(user7);
        user1.addFriends(user10);
        //Create relations for user3
        user3.addFriends(user1);
        user3.addFriends(user7);
        user3.addFriends(user2);
        user3.addFriends(user9);
        //Create relations for user7
        user7.addFriends(user1);
        user7.addFriends(user3);
        //Create relations for user10
        user10.addFriends(user1);
        //Create relations for user2
        user2.addFriends(user3);
        //Create relations for user9
        user9.addFriends(user3);
